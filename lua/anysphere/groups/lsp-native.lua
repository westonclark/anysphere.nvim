...
M.get_colors = function(conf)
  ...
  local hl = {
    ...
    ["@lsp.type.function"]                   = { fg = c.func },                      -- function declarations
    ...
    ["@lsp.type.method"]                     = { fg = c.func },                      -- method declarations
    ...
    ["@lsp.typemod.variable.defaultLibrary"] = { fg = c.type },                      -- default library variables
    ...
    ["@lsp.typemod.function"]                = { fg = c.number },                    -- function calls should be yellow like numbers
    ["@lsp.typemod.function.builtin"]        = treesitter["@function.builtin"],      -- built-in functions
    ["@lsp.typemod.function.definition"]     = { fg = c.func },                      -- function definitions should be orange
